...
//    JMenu fMenue = new JMenu("文件");
    ...
    JButton btn = new JButton(new AbstractAction("改变文本框背景颜色") {
        ...
        public void actionPerformed(ActionEvent e) {
            //弹出一个颜色选择器，
            java.awt.Color result = JColorChooser.showDialog(YeMian, "颜色选择器", java.awt.Color.BLACK);

            //修改文本框背景
            area.setBackground(result);
        }
    });
...
//        topLeft.add(area);
        YeMian.add(area,BorderLayout.NORTH);
...
//
//        SwingUtilities.updateComponentTreeUI(Yemian.getContentPane());
